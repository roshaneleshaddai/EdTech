...
export const Experience = () => {
  ...
  const mode = useAITeacher((state) => state.mode);
  const currentModule = useAITeacher((state) => state.currentModule);
  const currentAssessment = useAITeacher((state) => state.currentAssessment);

  const renderBoardContent = () => {
    if (mode === "course") {
      return <CourseInterface />;
    } else if (mode === "module" && currentModule) {
      return <ModuleInterface />;
    } else if (mode === "assessment" && currentAssessment) {
