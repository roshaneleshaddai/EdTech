...
// Map English teacher names to existing Japanese model files
const teacherModelMap = {
  "Guy": "Nanami",
  "Jenny": "Naoki", 
  "Aria": "Nanami",
  "Davis": "Naoki"
...
export function Teacher({ teacher, ...props }) {
  ...
  // Map English teacher name to existing Japanese model file
  const modelName = teacherModelMap[teacher] || "Nanami";
  
  const { scene } = useGLTF(`/models/Teacher_${modelName}.glb`);
  useEffect(() => {
  ...
  const { animations } = useGLTF(`/models/animations_${modelName}.glb`);
